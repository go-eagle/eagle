...
// and starts a new child span or root if there is a parent span.
func StartSpanFromRequest(operationName string, tracer opentracing.Tracer, r *http.Request) opentracing.Span {
